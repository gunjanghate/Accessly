...
export default function CreateEventForm() {
  ...
  return (
    <div id='create-event' className="max-w-2xl mx-auto p-6 bg-transparent backdrop-blur-2xl rounded-2xl shadow-xl my-12 relative border-2 hover:border-purple-700 border-t-indigo-600 border-purple-600 border-b-purple-600">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold text-gray-900">
            <span className="italic bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent font-semibold">Accesly</span> - Create Event
          </h1>
